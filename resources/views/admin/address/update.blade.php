...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('address_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Address</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('address')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor" name="address" class="form-control">{{$data->address}}</textarea>
