...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('title_store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Add  Title</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('title')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('photo')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <label class="col-form-label">Width: 1920 px , Height: 800 px </label>
