...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('title_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Title</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{url('admin/title',$data->id)}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('banner_title')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">Banner Title:</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" name="banner_title" value="{{$data->banner_title}}">
          ...
          <div class="form-group row custom_form{{$errors->has('sub_heading')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">sub_heading</label>
            <div class="col-sm-7">
