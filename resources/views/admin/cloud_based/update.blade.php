...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('cloud_based_update')}}" enctype="multipart/form-data">
      @csrf
        ...
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Cloud Based</h3>
            </div>
          ...
          <div class="form-group row custom_form{{$errors->has('icon')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <div class="row">
                ...
                <div class="col-4">
                  <img src="{{ asset('uploads/images/'.$data->icon) }}" style="width: 182px;" alt="">
                </div>
              </div>
            </div>
          </div>
