            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> All Category</h3>
                    </div>
                    <div class="col-md-6 text-right card_header_btn">
                        <a href="{{route('category_add')}}" class="btn"><i class="fa fa-plus-circle"></i> Add
                            Category</a>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm btn-color-ceate">
                                    <a href="{{route('category_view',$data->id)}}" class="btn btn-info view-btn">View</a>
