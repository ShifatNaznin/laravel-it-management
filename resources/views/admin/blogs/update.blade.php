        ...
        <div class="card">
          <div class="card-header header-part">
            <div class="row">
              <div class="col-md-6 card_header_title">
                <h3><i class="fa fa-gg-circle"></i> Update Blogs</h3>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group row custom_form{{$errors->has('category_id')? ' has-error':''}}">
              <label class="col-sm-3 col-form-label">Blogs Name:</label>
              <div class="col-sm-7">
                <select class="col-sm-12 form-control" name="category_id">
                  <option value="{{$data->category_id}}">{{$data->blogsCategory->name}}</option>
                  @php
