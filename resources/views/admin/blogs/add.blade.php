...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('blogs_store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Add Blogs</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('blogs')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('category_id')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <select class="col-sm-12 form-control" name="category_id">
                ...
                @php
                $blogsCategory=App\BlogsCategory::where('status', 1)->OrderBy('id', 'ASC')->get();
                @endphp
          ...
          <div class="form-group row custom_form{{$errors->has('sub_heading')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor2" name="sub_heading" class="form-control">{{old('sub_heading')}}</textarea>
          ...
          <div class="form-group row custom_form{{$errors->has('author')? ' has-error':''}}">
          ...
          <div class="form-group row custom_form{{$errors->has('photo')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <label class="col-form-label">Width: 900 px , Height: 600 px </label>
