...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('application_view_store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Add Application View</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('applicationview')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('application_id')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">Application Name:</label>
            <div class="col-sm-7">
              <select class="col-sm-12 form-control" name="application_id">
                <option value="">Select Application Category</option>
                @php
                $applicationCategory=App\Application::where('status', 1)->OrderBy('id', 'ASC')->get();
                @endphp
