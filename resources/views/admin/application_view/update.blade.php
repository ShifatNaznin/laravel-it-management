...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('application_view_update')}}" enctype="multipart/form-data">
      @csrf
        ...
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Application View</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('name')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              ...
              <option value="{{$data->application_id}}">{{$data->applicationCategory->heading}}</option>
                @php
