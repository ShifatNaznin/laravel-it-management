...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('pricing_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Pricing</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('pricing')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('plan')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">Phan:</label>
            <div class="col-sm-7">
            <input type="text" class="form-control" name="plan" value="{{$data->plan}}">
              @if ($errors->has('plan'))
              <span class="invalid-feedback" role="alert">
