...
<div class="container">
    <div class="row d-flex align-items-center m-row">
        ...
        @if (!empty($value->id))
            ...
            @php
            $cybersecurity = DB::table('cybersecurities')->where('id',$value->id)->first();
            @endphp
            ...
            <div class="col-md-7 col-lg-6 m-top">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    <h1 class="text-black" style="color: #ffffff;">{{$cybersecurity->heading ?? Null}}</h1>
                </div>
            </div>
            <div class="col-md-5 col-lg-6 m-top text-right">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    <img src="{{ asset('uploads/images/'.$cybersecurity->photo) }}" alt=""
                        style="height: 245px;">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="text-left mb-80">
                    ...
                    <h3 class="h2-xs" style="color:#01476d; font-size:30px;">{{$cybersecurity->heading?? Null}}
                    </h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row pricing-row">
                    @php
                    $products=DB::table('cybersecurity_views')->where('cybersecurity_id',$value->id)->get();
                    @endphp
