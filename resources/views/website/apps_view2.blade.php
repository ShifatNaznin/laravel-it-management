        ...
        <div class="row d-flex align-items-center m-row">
            ...
            <div class="col-md-7 col-lg-6 m-top">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    @php
                    $item = $view->appsPlan()->take(1)->get();
                    @endphp

                    @foreach ($item as $data)
                    <h1 class="text-black" style="color: #ffffff;">{{$data->appsCategory->heading}}</h1>
            ...
            <div class="col-md-5 col-lg-6 m-top text-right">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    <img src="{{ asset('uploads/images/'.$data->appsCategory->photo) }}" alt="" style="height: 245px;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="section-title mb-80">
                    ...
                    <h3 class="h2-xs" style="color:#01476d; font-size:40px;">{{$data->appsCategory->heading}}</h3>
                    <p>{!!$data->appsCategory->sub_heading!!}</p>
                </div>
            </div>
        </div>
        @endforeach
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row pricing-row">
                    @php
                    $products=$view->appsPlan()->paginate(100);
                    @endphp

                    @forelse ($products as $data)
                    <div class="col-md-4" id="cartAjax">
                        <div class="pricing-table wow fadeInLeft" data-wow-delay="0.4s">
                            ...
                            <a href="{{url('single-cartadd-apps/'.$data->id)}}"
                                class="btn cartadd btn-tra-grey-two blue-hover" id="cartItems">Order Now!</a>
