...
<section id="hero-9" class="bg-scroll hero-section division"
    ...
    <div class="container">
        <div class="row d-flex align-items-center m-row">
            ...
            @php
            $item = $value->cybersecurityPlan()->take(1)->get();
            // $item = DB::table('cybersecurity_views')->where('id','=','cybersecurity_id')->take(1)->get();
            @endphp
            ...
            <div class="col-md-7 col-lg-6 m-top">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    <h1 class="text-black" style="color: #ffffff;">{{$data->cybersecurityCategory->heading}}</h1>
                </div>
            </div>
            <div class="col-md-5 col-lg-6 m-top text-right">
                <div class="hero-9-txt pc-25 wow fadeInLeft banner-cls" data-wow-delay="0.6s">
                    <img src="{{ asset('uploads/images/'.$data->cybersecurityCategory->photo) }}" alt=""
                        style="height: 245px;">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="text-left mb-80">
                    ...
                    <h3 class="h2-xs" style="color:#01476d; font-size:30px;">{{$data->cybersecurityCategory->heading}}
                    </h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row pricing-row">
                    @php
                    $products=$value->cybersecurityPlan()->paginate(100);
                    @endphp
                    ...
                    <div class="col-md-4">
                        <div class="pricing-table wow fadeInLeft" data-wow-delay="0.4s">
                            ...
                            <a href="{{url('single-cartadd-cybersecurity/'.$data->id)}}" class="btn btn-tra-grey-two blue-hover"
